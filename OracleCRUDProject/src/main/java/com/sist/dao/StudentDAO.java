...
public class StudentDAO {
	...
	// 기능
	// 1. 목록 : SELECT => 페이징(자바, 오라클(인라인뷰)) => 오라클만 연동 => 출력 => main, 브라우저로 전송 => 데이터만 모아서 전송(목록) ArrayList
...
//				rs.next();
	...
	// 2. 추가 : INSERT => COMMIT(AutoCommit) - 주의
...
//				System.out.println(sql);
	...
	// 3. 상세보기 : SELECT WHERE => 반드시 Primary Key 값을 전송 
	...
	// 4. 수정 : UPDATE => COMMIT(AutoCommit) - 주의
	...
	// 5. 삭제 : DELETE => COMMIT(AutoCommit) - 주의
